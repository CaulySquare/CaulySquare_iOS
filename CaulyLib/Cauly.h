...
#define CAULY_SDK_VERSION		(@"4.0.3")
...
typedef enum {
    ...
    CaulySquareActionTypeExecutionComplete,
    CaulySquareActionTypeComplete
} CaulySquareActionType;
...
// Cauly Square 광고 이벤트 Delegate
@protocol CaulySquareDelegate <NSObject>
